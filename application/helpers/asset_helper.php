...
if ( ! function_exists('asset_url'))
{
    function asset_url()
    {
        ...
        return THEME_PATH . $CI->config->item('themes');
    }
}
...
if ( ! function_exists('css_url'))
{
    ...
    {
        $CI =& get_instance();
        return THEME_PATH . $CI->config->item('themes') . $CI->config->item('css_path') . $file;
    }
}
...
if ( ! function_exists('less_url'))
{
    ...
    {
        $CI =& get_instance();
        return THEME_PATH . $CI->config->item('themes') .  $CI->config->item('less_path');
    }
}
...
if ( ! function_exists('js_url'))
{
    ...
    {
        $CI =& get_instance();
        return THEME_PATH . $CI->config->item('themes') .  $CI->config->item('js_path');
    }
}
...
if ( ! function_exists('img_url'))
{
    ...
    {
        $CI =& get_instance();
        return THEME_PATH . $CI->config->item('themes') .  $CI->config->item('img_path'). $file;
    }
}
...
if ( ! function_exists('swf_url'))
{
    ...
    {
        $CI =& get_instance();
        return THEME_PATH . $CI->config->item('themes') .  $CI->config->item('swf_path');
    }
}
...
if ( ! function_exists('upload_url'))
{
    ...
    {
        $CI =& get_instance();
        return THEME_PATH . $CI->config->item('themes') .  $CI->config->item('upload_path');
    }
}
...
if ( ! function_exists('download_url'))
{
    ...
    {
        $CI =& get_instance();
        return THEME_PATH . $CI->config->item('themes') .  $CI->config->item('download_path');
    }
}
...
if ( ! function_exists('xml_url'))
{
    ...
    {
        $CI =& get_instance();
        return THEME_PATH . $CI->config->item('themes') .  $CI->config->item('xml_path');
    }
}
