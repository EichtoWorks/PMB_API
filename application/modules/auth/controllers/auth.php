...
class Auth extends Public_Controller {
	...
	function __construct()
	{
		...
		// GET THEMES
		$this->_themes = directory_map(ADDONS.'/themes/', 1);
	...
	function forgot_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
			$this->template->build('auth/forgot_password', $data);
		}
		else
		{
	...
	function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->template->build('auth/deactivate_user', $data);
		}
		else
		{
	...
	function create_user()
	{
		...
		else
		{
			...
			$this->template->build('auth/create_user', $data);
		}
	}
	...
	function create_group()
	{
		...
		else
		{
			...
			$this->template->build('auth/create_group', $data);
		}
	}
	...
	function edit_group($id)
	{
		...
		$this->template->build('auth/edit_group', $data);
	}
